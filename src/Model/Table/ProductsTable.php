...
class ProductsTable extends Table
{
    ...
    public function validationDefault(Validator $validator): Validator
    {
        ...
        $validator
            ->decimal('price')
            ->greaterThanOrEqual('price', 0.01, 'El precio debe ser mayor que 0.')
            ->lessThanOrEqual('price', 10000, 'El precio no puede ser mayor que 10,000.');

        // Validación del campo 'stock_quantity'
        $validator
        ->integer('stock_quantity', 'La cantidad de stock debe ser un número entero.')
        ->greaterThanOrEqual('stock_quantity', 0, 'La cantidad de stock debe ser mayor o igual a 0.')
        ->notEmptyString('stock_quantity', 'La cantidad de stock no puede estar vacía.');
        ...
        $validator
            ->inList('status', ['activo', 'inactivo'], 'El estado debe ser "activo" o "inactivo".');
